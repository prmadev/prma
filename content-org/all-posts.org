...
/How to not obssess over performance gain and improve changeability of {{{lang(Rust)}}} applications./
...
*** DONE ADHD not Being Real                                         :ADHD:
CLOSED: [2023-10-16 Mon 19:39]
:PROPERTIES:
:EXPORT_FILE_NAME: adhd-not-real
:END:

#+begin_quote
{{{abbr(ADHD,Attention-Deficit/Hyperactivity-Disorder)}}} is not real.
...
*** DONE Usage Restriction of Software Licenses :software:licenses:open_source:
CLOSED: [2023-10-16 Mon 23:05]
:PROPERTIES:
:EXPORT_FILE_NAME: usage-restriction-software-licenses
:END:

Please think twice before saying, {{{q(people,usage restriction is good because you might want to prevent someone from using your tool for war\, crime\, etc.)}}}
...
*** DONE O'Reilly Book Covers                                       :books:
CLOSED: [2023-10-16 Mon 23:04]
:PROPERTIES:
:EXPORT_FILE_NAME: oreilly-book-covers
:END:
...
*** DONE I hate Jira                            :software_development:jira:
CLOSED: [2023-10-16 Mon 23:04]
:PROPERTIES:
:EXPORT_FILE_NAME: i-hate-jira
:END:
...
*** DONE Prototyping in Software development         :software_development:
CLOSED: [2023-10-16 Mon 23:04]
:PROPERTIES:
:EXPORT_FILE_NAME: prototying-software-development
:END:
...
*** DONE Rust's Productivity                             :rust:programming:
CLOSED: [2023-10-16 Mon 23:04]
:PROPERTIES:
:EXPORT_FILE_NAME: rust-productivity
:END:
...
*** DONE Centralization Around GitHub     :github:codeberg:enshitification:
CLOSED: [2023-10-16 Mon 23:04]
:PROPERTIES:
:EXPORT_FILE_NAME: github-centralization
:END:
...
*** DONE Test of 10x Developer                                :development:
CLOSED: [2023-10-16 Mon 23:10]
:PROPERTIES:
:EXPORT_FILE_NAME: test-of-10x-devleopers
:END:
...
*** DONE Older, Better Technologies                       :enshitification:
CLOSED: [2023-10-16 Mon 23:04]
:PROPERTIES:
:EXPORT_FILE_NAME: older-better-technologies
:END:
It is very illuminating to see that using older style technologies, may lead to better experience.
This just goes to show that many of the features and complexity and progress are not /for people/, but for profit of a few.
That, of course, is a wild speculation of the highest order.

*** DONE Dynamic Linking is the Wrong solution   :software:dynamic_linking:
CLOSED: [2023-10-16 Mon 23:03]
:PROPERTIES:
:EXPORT_FILE_NAME: dynamic-linking-the-wrong-solution
:END:
